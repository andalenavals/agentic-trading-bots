...
* ARIMAX with price-only features
* ARIMAX with price + sentiment features
...
Ridge ARX, ARIMAX, one-step LightGBM, Gaussian process, and LSTM support two evaluation modes in the app:
