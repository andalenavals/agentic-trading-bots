  ...
  return (
    <section className="panel">
      ...
      <div className="summary">
        <strong>Latest market read:</strong> {signal.latestSummary || "No summary available for this date."}
      </div>
...
function PriceTooltip({ active, payload, color }: { active?: boolean; payload?: Array<{ payload: SentimentPoint }>; color: string }) {
  ...
  return (
    <div className="panel" style={{ maxWidth: 340, padding: 12 }}>
      ...
      <p className="muted" style={{ fontSize: 12, lineHeight: 1.35, marginTop: 8 }}>{point.newsSummary}</p>
    </div>
  );
}
