...
* ``prediction_baseline.py``, ``prediction_gaussian_process.py``, ``prediction_ridge_arx.py``, ``prediction_lightgbm.py``, ``prediction_lightgbm_direct.py``, and ``prediction_lstm.py``: forecast generators
